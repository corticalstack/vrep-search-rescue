    ...
    def __init__(self):
        ...
        self.world = {'props': {'min_dist_enabled': True, 'min_dist': 0.05, 'max_dist': 0.28},
                      'events': [{'task': 'turn', 'degrees': +359},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 5, 'velocity': 0.15},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +91},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 5, 'velocity': 0.15},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +90},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 8.75, 'velocity': 0.15},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +90},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 8, 'velocity': 0.15},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +90},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 8.75, 'velocity': 0.15},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +90},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 3.5, 'velocity': 0.15},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +45},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 8, 'velocity': 0.15},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +45},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 5.75, 'velocity': 0.15},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +90},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 13.25, 'velocity': 0.15},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +90},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 13.15, 'velocity': 0.15},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +90},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 13.5, 'velocity': 0.15},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +90},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 13, 'velocity': 0.15},
                                 {'task': 'stop'}]}
        """
        ...
        self.world = {'props': {'min_dist_enabled': True, 'min_dist': 0.10, 'max_dist': 0.28},
                      'events': [{'task': 'turn', 'degrees': +359},
                                 ...
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +90},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 3.4, 'velocity': 0.2},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +45},
                                 {'task': 'move', 'robot_dir_travel': 1, 'distm': 7.8, 'velocity': 0.2},
                                 {'task': 'stop'},
                                 {'task': 'turn', 'degrees': +45},
